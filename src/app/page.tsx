      ...
      <main className="flex min-h-screen flex-col items-center justify-center p-24">
        ...
        {status === "form" &&
          <div className='flex justify-center items-center flex-col mb-5'>
            ...
            <p className='text-red-600'>Your opinion will remain anonymous, and we will not share your information.</p>
          </div>
        }

        {status === "success" &&
          <div className='flex justify-center items-center flex-col'>
            <h2 className='text-2xl font-bold'>Thank you very much for collaborating with us and completing the survey. Your participation is greatly appreciated!</h2>
          ...
          <form onSubmit={methods.handleSubmit(handleFormSubmit)}>
            {step === 1 && (
              <motion.div
                ...
                className='bg-blue-300 p-10 w-[700px] h-[500px] gap-5 flex flex-col justify-between rounded-[10px]'
              >
                <VoterInfo />
              </motion.div>
            )}
